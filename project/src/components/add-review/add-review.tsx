    ...
    <div className="add-review">
      <form action="#" className="add-review__form">
        ...
        <div className="add-review__text">
          <textarea onChange={fieldChangeHandle} value={formData.reviewText} className="add-review__textarea" name="reviewText" id="review-text" placeholder="Review text"></textarea>
